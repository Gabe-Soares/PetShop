...
@Component({
  selector: 'app-list-my-pets',
  templateUrl: './list-my-pets.component.html',
  styleUrls: ['./list-my-pets.component.scss']
})
export class ListMyPetsComponent implements OnInit {

  displayedColumns: string[] = ['Id', 'Name', 'NickName', 'Age', 'Type', 'Breed'];
  dataSource: MatTableDataSource<PetModel>;
...
function createNewUser(id: number): PetModel {
